...
java -Dconfig.file=$CONFIG -DLOGS_DIR=$LOGS_DIR -Dlogback.configurationFile=$LOGS_CONFIG -Dfile.ending=UTF8  -cp $SCALA_HOME/lib/scala-library.jar  -jar es-kafkatest-app-server.jar --process $PROCESS